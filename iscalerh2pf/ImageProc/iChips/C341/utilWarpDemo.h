#ifndef _UTIL_WARP_DEMO_H_
#define _UTIL_WARP_DEMO_H_
...
#define CRC16_DEFAULT_WARP_TABLE_X (8667)
#define CRC16_DEFAULT_WARP_TABLE_Y (35094)
...
typedef enum
{
	...
	APPLY_BLACKLEVEL__WITHOSD,		//with OSD menu
...
typedef enum
{
	/* 000 */ COLOR_IDX__GREEN,
	/* 001 */ COLOR_IDX__MAGENTA,
	/* 002 */ COLOR_IDX__RED,
	/* 003 */ COLOR_IDX__CYAN,
	/* 004 */ COLOR_IDX__BLUE,
	/* 005 */ COLOR_IDX__YELLOW,
	/* 006 */ COLOR_IDX__BLACK,
	/* 007 */ COLOR_IDX__WHITE,
	/* 008 */ COLOR_IDX__DARK_GREEN,
	/* 009 */ COLOR_IDX__DARK_MAGENTA,
	/* 010 */ COLOR_IDX__DARK_RED,
	/* 011 */ COLOR_IDX__DARK_CYAN,
	/* 012 */ COLOR_IDX__BLACKLEVEL_GREEN,    //A65_OPTOMA_Doulas_0020
	/* 013 */ COLOR_IDX__BLACKLEVEL_MAGENTA,  //A65_OPTOMA_Doulas_0020
	/* 014 */ COLOR_IDX__BLACKLEVEL_RED,      //A65_OPTOMA_Doulas_0020
	/* 015 */ COLOR_IDX__BLACKLEVEL_CYAN,     //A65_OPTOMA_Doulas_0020
	/* 016 */ COLOR_IDX__BLACK_BKG,			//black for background
    /* 017 */ COLOR_IDX__GREY192,   //for ACU sel target grid pattern
//	COLOR_IDX__BMP_START 	= 0x10,	//A65_OPTOMA_Doulas_0020//start index for BMP
	...
	/* 241 */ COLOR_IDX__BLACK_BLINK,         //A65_OPTOMA_Doulas_0020
