...
#include "dvC341.h" //H30K_Doulas_0011
...
typedef enum
{
    ...
    eHAL_SCALER_EXEC_CODE_MUTEX_LOCKED,
...
typedef enum
{
    eCLOCKGEN_SEL_C734,
    eCLOCKGEN_SEL_C790,
    eCLOCKGEN_SEL_C341_HD,
    eCLOCKGEN_SEL_C341_WU,
    eCLOCKGEN_SEL_C341_720P,
    eCLOCKGEN_SEL_C341_720P120,
    eCLOCKGEN_SEL_C341_800x600_120,
    eCLOCKGEN_SEL_C341_1080P120,
    eCLOCKGEN_SEL_C341_WUXGA120,
    eCLOCKGEN_SEL_LAST,
}eCLOCKGEN_SEL;
...
#ifdef Low_Latency_All
eHAL_SCALER_EXEC_CODE halScaler_Low_Latency_Set(eLOW_LATENCY_MODE eLLMode);	//ZU860_Clare_0152
eLOW_LATENCY_MODE halScaler_Low_Latency_Get(void);	//ZU860_Clare_0152
UINT8 halScaler_Is_LowLatencyMode_On(void);
...
eHAL_SCALER_EXEC_CODE halScaler_C341_Auto_Fill_Screen_Init(void);    		  //G100_Steven_0051
eHAL_SCALER_EXEC_CODE halScaler_C341_Auto_Fill_Screen_Setting(BOOL bSetting); //G100_Steven_0051
...
eHAL_SCALER_EXEC_CODE halScaler_STATECH1(void); //H30K_Doulas_0035
eHAL_SCALER_EXEC_CODE halScaler_3DFLD_Check(UINT8 *ucIsReconfig);   //H30K_Doulas_0035
