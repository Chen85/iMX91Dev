#include "dvC821.h"       //A70LV_Doulas_0013
...
eHAL_SCALER_EXEC_CODE halScaler_PowerNormal(UINT8 ucCH, const ePANEL_ID ePanelId)
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
            ...
            if(ucCH == eMCT_CH1)
            {
                ...
                switch(m_sHalScalerInfo[ucCH].ePanelTimingId)    //A70LV_Doulas_0094 modify
                {
                    case ePANEL_ID_1080P_60HZ:
                        eSel = eVCXO_SEL_C821_HD;
                        break;

                    case ePANEL_ID_WUXGA_60HZ:
                        eSel = eVCXO_SEL_C821_WU;
                        break;

                    case ePANEL_ID_720P_120HZ:
                        eSel = eVCXO_SEL_C821_720P120;
                        break;

                    case ePANEL_ID_SVGA_120HZ:
                        eSel = eVCXO_SEL_C821_800x600_120;
                        break;

                    case ePANEL_ID_1080P_120HZ:
                        eSel = eVCXO_SEL_C821_1080P120;
                        break;

                    case ePANEL_ID_WUXGA_120HZ:
                        eSel = eVCXO_SEL_C821_WUXGA120;
                        break;
        ...
        /*    if((ulExeRet = dvVCXO949_Init(eVCXO_SEL_C790)) != eVCXO_EXEC_CODE_PASS)
            {
                m_sHalScalerInfo[ucCH].ulVCXOErrCode = ulExeRet;
                xSemaphoreGive(m_sHalScalerInfo[ucCH].xSemaphore);
                return eHAL_SCALER_EXEC_CODE_DV_RX_INIT_FAIL;
            ...
            //Board_Gpio_Set(pNXP_FPGA_RST, HIGH);
            ...
            if((ulExeRet = dvC821_Init_2K((eMCT)ucCH, ePanelId)) != eC821_EXEC_CODE_PASS)
            {
            ...
            //TODO
            dvC821_SetOverlay_2K((eMCT)ucCH, !!m_sUserSystemSetting.sSourceSetting.ucPIPEnable);  //A70LV_Doulas_0024
            //dvC821_SetOverlayCoef_2K((eMCT)ucCH, ucOverlay);

            dvC821_SetInputPort_2K((eMCT)ucCH);
        }
...
eHAL_SCALER_EXEC_CODE halScaler_ConfigureForDisplay(UINT8 ucCH, const UINT8 ucColorFmt)
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        dvC821_BuildPicture_2K((eMCT)ucCH);
        ...
        if(ucCH == eMCT_CH1)    //A70LV_Doulas_0079
        {
            ...
            UINT16 uiH_Toral;
            UINT16 uiV_Toral;
            dvC821_ForceSyncRese_Get(&bForceSyncReseVal,&uiH_Toral,&uiV_Toral);
         ...
         //   dvC821_SetOutputColor_2K((eMCT)ucCH, (eCOLOR_FORMAT)ucColorFmt);  //A70LV_Doulas_0002 debug
...
eHAL_SCALER_EXEC_CODE halScaler_ConfigureForDisplay_ChangePIPLayout(UINT8 ucCH, const UINT8 ucColorFmt)     //A35G2_CDS_Simon_0001
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        dvC821_BuildPicture_2K_ChangePIPLayout((eMCT)ucCH);
                            ...
                            const UINT8 ucFillColor, const BOOL bEnable)
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        dvC821_SetAutoFill_2K((eMCT)ucCH, ucFillColor, bEnable);
...
eHAL_SCALER_EXEC_CODE halScaler_SetOverlay(UINT8 ucCH, UINT8 ucEnable)
{
...

    {
        ...
        if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
        {
            ...
            dvC821_SetOverlay_2K((eMCT)ucCH, ucEnable);
            halScaler_SemaphoreGive(__FUNCTION__);
...
eHAL_SCALER_EXEC_CODE halScaler_SetOverlayCoef(UINT8 ucCH, const PUINT8 pucOverLay)
{
...

    {
        ...
        if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
        {
            ...
            dvC821_SetOverlayCoef_2K((eMCT)ucCH, pucOverLay);
            halScaler_SemaphoreGive(__FUNCTION__);
...
//    LOG_MSG(db_HAL_SCALER, "(func:%s, line:%d)\r\n", __FUNCTION__, __LINE__);
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        {
            if(dvC821_CheckInput_2K((eMCT)ucCH))
            {
				dvC821_SetIdual_2K((eMCT)ucCH);
            }
            else
            {
...
eHAL_SCALER_EXEC_CODE halScaler_Brightness_Set(UINT8 ucCH,UINT8 ucSetting)  //A70LV_Doulas_0072 modify //A70LV_Doulas_0022 modify  //A70LV_Doulas_0009 modify
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        if(halScaler_PIP_PBP_Enable_Get())  //A70LV_Doulas_0389 Modify
        {
            ...
            dvC821_SetBrightness((eMCT)ucCH);
        }
        else
        {
        	 if(ucCH == eMCT_CH1)
        	 {
        		 dvC821_SetBrightness(eMCT_CH1);       //A70LV_Doulas_0155
        		 dvC821_SetBrightness(eMCT_CH2);       //A70LV_Doulas_0155
        	 }
...
eHAL_SCALER_EXEC_CODE halScaler_Contrast_Set(UINT8 ucCH,UINT8 ucSetting)    //A70LV_Doulas_0072 modify//A70LV_Doulas_0022 //A70LV_Doulas_0009 modify
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        {
            dvC821_SetContrast((eMCT)ucCH);
        }
        else
        {
            if(ucCH == eMCT_CH1)
            {
            	dvC821_SetContrast(eMCT_CH1);     //A70LV_Doulas_0155
            	dvC821_SetContrast(eMCT_CH2);     //A70LV_Doulas_0155
            }
        }//G100_Steven_0079 end
...
eHAL_SCALER_EXEC_CODE halScaler_HUE_Set(UINT8 ucCH,UINT8 ucSetting)  //A70LV_Doulas_0072 modify//A70LV_Doulas_0022 modify
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        dvC821_Set_HUE(eMCT_CH1);        //A70LV_Doulas_0155 //A70LV_Doulas_0008 modify
        dvC821_Set_HUE(eMCT_CH2);        //A70LV_Doulas_0155
        halScaler_SemaphoreGive(__FUNCTION__);
    }
    else
    {
...
eHAL_SCALER_EXEC_CODE halScaler_Saturation_Set(UINT8 ucCH,UINT8 ucSetting)  //A70LV_Doulas_0072 modify//A70LV_Doulas_0022
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        dvC821_Set_Saturation(eMCT_CH1);        //A70LV_Doulas_0155 modify//A70LV_Doulas_0008 modify
        dvC821_Set_Saturation(eMCT_CH2);        //A70LV_Doulas_0155
...
eHAL_SCALER_EXEC_CODE halScaler_PIP_PBP_Layout_Set(UINT8 ucLayout)    //A70LV_Doulas_0072 modify//A70LV_Doulas_0024
{
    ...
    dvC821_Set_PIP_PBP_Layout(ucLayout);
...
eHAL_SCALER_EXEC_CODE halScaler_PIP_PBP_Size_Set(UINT8 ucSize)    //A70LV_Doulas_0072 modify//A70LV_Doulas_0024
{
    ...
    dvC821_Set_PIP_PBP_Size(ucSize);
...
{
    dvC821_Resync_Init((eMCT)eCH);  //A70LV_Doulas_0008 modify
}
...
//    LOG_MSG(db_HAL_SCALER, "(func:%s, line:%d)\r\n", __FUNCTION__, __LINE__);
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        bSyncLock = dvC821_SYNC_LOCK_Compare((eMCT)ucCH);    //A70LV_Doulas_0009 modify
        if(bSyncLock)
        {
...
eHAL_SCALER_EXEC_CODE halScaler_CheckChannelSyncCount(UINT8 *ucIsSimilar)
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        dvC821_InputPort_Sync_MCLK_Count_Get(eMCT_CH1, &lCH1_IMFH, &lCH1_IMFV);
        dvC821_InputPort_Sync_MCLK_Count_Get(eMCT_CH2, &lCH2_IMFH, &lCH2_IMFV);
...
//    LOG_MSG(db_HAL_SCALER, "(func:%s, line:%d)\r\n", __FUNCTION__, __LINE__);
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        dvC821_Freeze_Set((eMCT)ucCH,bFreezeEn);    //A70LV_Doulas_0008 modify
...
//    LOG_MSG(db_HAL_SCALER, "(func:%s, line:%d)\r\n", __FUNCTION__, __LINE__);
    ...
    *bFreezeEn = dvC821_Freeze_Get((eMCT)ucCH);     //A70LV_Doulas_0008 modify
...
//    LOG_MSG(db_HAL_SCALER, "(func:%s, line:%d)\r\n", __FUNCTION__, __LINE__);
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        if(ucCH == eMCT_CH1)
        {
            ...
            dvC821_Panel_Change_LVDS_Stop();
            dvC821_Panel_Change_Setting(eMCT_CH1,ePanelId);
...
eHAL_SCALER_EXEC_CODE halScaler_AutoPhaseStart(UINT8 ucCH)  //A70LV_Doulas_0007
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        eResult = dvC821_AutoPhaseStart((eMCT)ucCH);    //A70LV_Doulas_0008 modify
        if(eResult == eC821_EXEC_CODE_PASS)
        {
            ...
            ucCurrentPhase = dvC821_CurrentPhaseGet((eMCT)ucCH);
...
eHAL_SCALER_EXEC_CODE halScaler_AutoPhase(UINT8 ucCH)  //A70LV_Doulas_0007
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        eResult = dvC821_AutoPhase((eMCT)ucCH);     //A70LV_Doulas_0008 modify
        if(eResult == eC821_EXEC_CODE_PASS)
        {
            UINT8 ucBestPhase = dvC821_BsetPhaseGet((eMCT)ucCH);      //A70LV_Doulas_01136//A70LV_Doulas_0008 modify
        ...
        else if(eResult == eC821_EXEC_CODE_CH_AUTO_PHASE)
        {
            ucCurrentPhase = dvC821_CurrentPhaseGet((eMCT)ucCH);    //A70LV_Doulas_0008 modify
...
eHAL_SCALER_EXEC_CODE halScaler_SetInputSource(UINT8 ucCH,UINT8 ucInputSource)  //A70LV_Doulas_0007
{
    ...
    if(ucInputSourceChanged)
    {
        ...
        #endif
        #endif
        dvC821_InputSourceSet((eMCT)ucCH,ucInputSource);    //A70LV_Doulas_0008 modify
        //halScaler_IintChannelSetting(ucCH);
        halScaler_IintChannelSetting(eMCT_CH1); //ZU860_Doulas_0082
        halScaler_IintChannelSetting(eMCT_CH2); //ZU860_Doulas_0082
    }
...
eHAL_SCALER_EXEC_CODE halScaler_RedOffset_Set(UINT8 ucCH,UINT8 ucSetting)  //A70LV_Doulas_0072 modify//A70LV_Doulas_0029 //A70LV_Doulas_0022 modify   //A70LV_Doulas_0011
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        dvC821_Set_RGB_Offset(eMCT_CH1);      //A70LV_Doulas_0155 //A70LV_Doulas_0072 modify
        dvC821_Set_RGB_Offset(eMCT_CH2);      //A70LV_Doulas_0155
...
eHAL_SCALER_EXEC_CODE halScaler_RedGain_Set(UINT8 ucCH,UINT8 ucSetting)  //A70LV_Doulas_0072 modify//A70LV_Doulas_0029 //A70LV_Doulas_0022 modify      //A70LV_Doulas_0011
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        dvC821_Set_RGB_Gain(eMCT_CH1);    //A70LV_Doulas_0155 //A70LV_Doulas_0072 modify
        dvC821_Set_RGB_Gain(eMCT_CH2);    //A70LV_Doulas_0155
...
eHAL_SCALER_EXEC_CODE halScaler_RedOffset_Value_Set(UINT8 ucCH,UINT8 ucSetting)  //A70LV_Doulas_0072 modify//A70LV_Doulas_0022 modify  //A70LV_Doulas_0012
{
    ...
    iC821_setting = (INT16)(((DOUBLE)ucSetting/(DOUBLE)(RED_OFFSET_MAX_VALUE - RED_OFFSET_MIN_VALUE))*(C821_RED_OFFSET_MAX - C821_RED_OFFSET_MIN)) + C821_RED_OFFSET_MIN;

    dvC821_RedOffset_Value_Set(eMCT_CH1,iC821_setting);     //A70LV_Doulas_0155
    dvC821_RedOffset_Value_Set(eMCT_CH2,iC821_setting);     //A70LV_Doulas_0155
...
eHAL_SCALER_EXEC_CODE halScaler_GreenOffset_Value_Set(UINT8 ucCH,UINT8 ucSetting)  //A70LV_Doulas_0072 modify//A70LV_Doulas_0022 modify  //A70LV_Doulas_0012
{
    ...
    //convert range 0~100(default:50) to -511~511(default:0)
    iC821_setting = (INT16)(((DOUBLE)ucSetting/(DOUBLE)(GREEN_OFFSET_MAX_VALUE - GREEN_OFFSET_MIN_VALUE))*(C821_GREEN_OFFSET_MAX - C821_GREEN_OFFSET_MIN)) + C821_GREEN_OFFSET_MIN;

    dvC821_GreenOffset_Value_Set(eMCT_CH1,iC821_setting);       //A70LV_Doulas_0155
    dvC821_GreenOffset_Value_Set(eMCT_CH2,iC821_setting);       //A70LV_Doulas_0155
...
eHAL_SCALER_EXEC_CODE halScaler_BlueOffset_Value_Set(UINT8 ucCH,UINT8 ucSetting)  //A70LV_Doulas_0072 modify//A70LV_Doulas_0022 modify  //A70LV_Doulas_0012
{
    ...
    //convert range 0~100(default:50) to -511~511(default:0)
    iC821_setting = (INT16)(((DOUBLE)ucSetting/(DOUBLE)(BLUE_OFFSET_MAX_VALUE - BLUE_OFFSET_MIN_VALUE))*(C821_BLUE_OFFSET_MAX - C821_BLUE_OFFSET_MIN)) + C821_BLUE_OFFSET_MIN;

    dvC821_BlueOffset_Value_Set(eMCT_CH1,iC821_setting);        //A70LV_Doulas_0155
    dvC821_BlueOffset_Value_Set(eMCT_CH2,iC821_setting);        //A70LV_Doulas_0155
...
eHAL_SCALER_EXEC_CODE halScaler_RedGain_Value_Set(UINT8 ucCH,UINT8 ucSetting)  //A70LV_Doulas_0072 modify//A70LV_Doulas_0022 modify     //A70LV_Doulas_0012
{
    ...
    {
        dC821_setting = (DOUBLE)ucSetting/(DOUBLE)(RED_GAIN_DEFAULT_VALUE-RED_GAIN_MIN_VALUE)*(C821_RED_GAIN_DEFAULT-C821_RED_GAIN_MIN);
    }
    else if (ucSetting>RED_GAIN_DEFAULT_VALUE)
    {
        dC821_setting = ((DOUBLE)ucSetting-RED_GAIN_DEFAULT_VALUE)/(DOUBLE)(RED_GAIN_MAX_VALUE-RED_GAIN_DEFAULT_VALUE)*(C821_RED_GAIN_MAX-C821_RED_GAIN_DEFAULT) + C821_RED_GAIN_DEFAULT;
    }
    else
    {
        dC821_setting = C821_RED_GAIN_DEFAULT;
    }

    dvC821_RedGain_Value_Set(eMCT_CH1,dC821_setting);       //A70LV_Doulas_0155
    dvC821_RedGain_Value_Set(eMCT_CH2,dC821_setting);       //A70LV_Doulas_0155
    return eResult;
}
...
eHAL_SCALER_EXEC_CODE halScaler_GreenGain_Value_Set(UINT8 ucCH,UINT8 ucSetting)  //A70LV_Doulas_0072 modify//A70LV_Doulas_0022 modify     //A70LV_Doulas_0012
{
    ...
    {
        dC821_setting = (DOUBLE)ucSetting/(DOUBLE)(GREEN_GAIN_DEFAULT_VALUE-GREEN_GAIN_MIN_VALUE)*(C821_GREEN_GAIN_DEFAULT-C821_GREEN_GAIN_MIN);
    }
    else if (ucSetting>GREEN_GAIN_DEFAULT_VALUE)
    {
        dC821_setting = ((DOUBLE)ucSetting-GREEN_GAIN_DEFAULT_VALUE)/(DOUBLE)(GREEN_GAIN_MAX_VALUE-GREEN_GAIN_DEFAULT_VALUE)*(C821_GREEN_GAIN_MAX-C821_GREEN_GAIN_DEFAULT) + C821_GREEN_GAIN_DEFAULT;
    }
    else
    {
        dC821_setting = C821_GREEN_GAIN_DEFAULT;
    }

    dvC821_GreenGain_Value_Set(eMCT_CH1,dC821_setting);     //A70LV_Doulas_0155
    dvC821_GreenGain_Value_Set(eMCT_CH2,dC821_setting);     //A70LV_Doulas_0155
...
eHAL_SCALER_EXEC_CODE halScaler_BlueGain_Value_Set(UINT8 ucCH,UINT8 ucSetting)  //A70LV_Doulas_0072 modify//A70LV_Doulas_0022 modify     //A70LV_Doulas_0012
{
    ...
    {
        dC821_setting = (DOUBLE)ucSetting/(DOUBLE)(BLUE_GAIN_DEFAULT_VALUE-BLUE_GAIN_MIN_VALUE)*(C821_BLUE_GAIN_DEFAULT-C821_BLUE_GAIN_MIN);
    }
    else if (ucSetting>BLUE_GAIN_DEFAULT_VALUE)
    {
        dC821_setting = ((DOUBLE)ucSetting-BLUE_GAIN_DEFAULT_VALUE)/(DOUBLE)(BLUE_GAIN_MAX_VALUE-BLUE_GAIN_DEFAULT_VALUE)*(C821_BLUE_GAIN_MAX-C821_BLUE_GAIN_DEFAULT) + C821_BLUE_GAIN_DEFAULT;
    }
    else
    {
        dC821_setting = C821_BLUE_GAIN_DEFAULT;
    }
    dvC821_BlueGain_Value_Set(eMCT_CH1,dC821_setting);      //A70LV_Doulas_0155
    dvC821_BlueGain_Value_Set(eMCT_CH2,dC821_setting);      //A70LV_Doulas_0155
...
eHAL_SCALER_EXEC_CODE halScaler_Brightness_Value_Set(UINT8 ucCH,UINT8 ucSetting)  //A70LV_Doulas_0072 modify//A70LV_Doulas_0022 modify  //A70LV_Doulas_0012
{
    ...
    iC821_setting = (INT16)(((DOUBLE)ucSetting/(DOUBLE)(BRIGHTNESS_MAX_VALUE - BRIGHTNESS_MIN_VALUE))*(C821_BRIGHTNESS_MAX - C821_BRIGHTNESS_MIN)) + C821_BRIGHTNESS_MIN;
    LOG_MSG(db_HAL_SCALER, "(func:%s, line:%d): c821 Brightness=%d\r\n", __FUNCTION__, __LINE__, iC821_setting);

    if(halScaler_PIP_PBP_Enable_Get()) //G100_Steven_0079 start
    {
    	//LOG_MSG(db_ALWAYS, "Brightness111_Set CH %d, Val %d\r\n",ucCH, iC821_setting);
        dvC821_Brightness_Value_Set(ucCH,iC821_setting);
    }
    else
    {
    	if(ucCH == eMCT_CH1)
    	{
    		dvC821_Brightness_Value_Set(eMCT_CH1,iC821_setting);
    		dvC821_Brightness_Value_Set(eMCT_CH2,iC821_setting);
    	}
    } //G100_Steven_0079 end
...
eHAL_SCALER_EXEC_CODE halScaler_Contrast_Value_Set(UINT8 ucCH,UINT8 ucSetting)     //A70LV_Doulas_0072 modify//A70LV_Doulas_0022
{
    ...
    {
        dC821_setting = (DOUBLE)ucSetting/(DOUBLE)(CONTRAST_DEFAULT_VALUE-CONTRAST_MIN_VALUE)*(C821_CONTRAST_DEFAULT-C821_CONTRAST_MIN);
    }
    else if (ucSetting>CONTRAST_DEFAULT_VALUE)
    {
        dC821_setting = ((DOUBLE)ucSetting-CONTRAST_DEFAULT_VALUE)/(DOUBLE)(CONTRAST_MAX_VALUE-CONTRAST_DEFAULT_VALUE)*(C821_CONTRAST_MAX-C821_CONTRAST_DEFAULT) + C821_CONTRAST_DEFAULT;
    }
    else
    {
        dC821_setting = C821_CONTRAST_DEFAULT;
    }

    if(halScaler_PIP_PBP_Enable_Get())  //G100_Steven_0079 start //A70LV_Doulas_0389 Modify
    {
        dvC821_Contrast_Value_Set(ucCH,dC821_setting);
    }
    else
    {
    	if(ucCH == eMCT_CH1)
    	{
    		dvC821_Contrast_Value_Set(eMCT_CH1,dC821_setting);      //A70LV_Doulas_0155
    		dvC821_Contrast_Value_Set(eMCT_CH2,dC821_setting);      //A70LV_Doulas_0155
    	}
    } //G100_Steven_0079 end
...
eHAL_SCALER_EXEC_CODE halScaler_HUE_Value_Set(UINT8 ucCH,UINT8 ucSetting)  //A70LV_Doulas_0072 modify//A70LV_Doulas_0022
{
    ...
    iC821_setting = (INT16)(((DOUBLE)ucSetting/(DOUBLE)(HUE_MAX_VALUE - HUE_MIN_VALUE))*(C821_HUE_MAX - C821_HUE_MIN)) + C821_HUE_MIN;
    dvC821_Set_HUE_Value(eMCT_CH1,iC821_setting);     //A70LV_Doulas_0155
    dvC821_Set_HUE_Value(eMCT_CH2,iC821_setting);     //A70LV_Doulas_0155
...
eHAL_SCALER_EXEC_CODE halScaler_Saturation_Value_Set(UINT8 ucCH,UINT8 ucSetting)  //A70LV_Doulas_0072 modify//A70LV_Doulas_0022
{
    ...
    {
        dC821_setting = (DOUBLE)ucSetting/(DOUBLE)(SATURATION_DEFAULT_VALUE- SATURATION_MIN_VALUE)*(C821_SATURATION_DEFAULT-C821_SATURATION_MIN);
    }
    else if (ucSetting> SATURATION_DEFAULT_VALUE)
    {
        dC821_setting = ((DOUBLE)ucSetting- SATURATION_DEFAULT_VALUE)/(DOUBLE)(SATURATION_MAX_VALUE- SATURATION_DEFAULT_VALUE)*(C821_SATURATION_MAX- C821_SATURATION_DEFAULT) + C821_SATURATION_DEFAULT;
    }
    else
    {
        dC821_setting = C821_SATURATION_DEFAULT;
    }
    dvC821_Set_Saturation_Value(eMCT_CH1,dC821_setting);      //A70LV_Doulas_0155
    dvC821_Set_Saturation_Value(eMCT_CH2,dC821_setting);      //A70LV_Doulas_0155
...
eHAL_SCALER_EXEC_CODE halScaler_SizePresets_Set(UINT8 ucSetting) //A70LV_Doulas_0020
{
    ...
    dvC821_Set_SizePresets_Value(eMCT_CH2,ucSetting);      //A70LV_Doulas_0155 Add
    eC821Resut = dvC821_Set_SizePresets_Value(eMCT_CH1,ucSetting);
    if(eC821Resut != eC821_EXEC_CODE_PASS)
    {
        eResult = eHAL_SCALER_EXEC_CODE_FAIL;
    }
...
eHAL_SCALER_EXEC_CODE halScaler_Overscan_Set(UINT8 ucSetting)    //A70LV_Doulas_0072 modify
{
    ...
    dvC821_Overscan_Set(eMCT_CH2,(eOVER_SCAN_TYPE)ucSetting);      //A70LV_Doulas_0155
    eC821Resut = dvC821_Overscan_Set(eMCT_CH1,(eOVER_SCAN_TYPE)ucSetting);
    if(eC821Resut != eC821_EXEC_CODE_PASS)
    {
        eResult = eHAL_SCALER_EXEC_CODE_FAIL;
    }
...
eHAL_SCALER_EXEC_CODE halScaler_PixelPhase_Action(void)     //A70LV_Doulas_0117
{
    ...
    ucPhase = (UINT8)(((UINT16)ucSetting - PHASE_DEFAULT_VALUE + (UINT16)dvC821_BsetPhaseGet(eMCT_CH1) + 64)%32);
...
eHAL_SCALER_EXEC_CODE halScaler_HorzPosition_Set(UINT8 ucSetting)    //A70LV_Doulas_0072 modify
{
    ...
    dvC821_Horz_Start_Position_Set(eMCT_CH2,ucSetting);     //A70LV_Doulas_0155
    eC821Resut = dvC821_Horz_Start_Position_Set(eMCT_CH1,ucSetting);
    if(eC821Resut != eC821_EXEC_CODE_PASS)
    {
        eResult = eHAL_SCALER_EXEC_CODE_FAIL;
    }
...
eHAL_SCALER_EXEC_CODE halScaler_VertPosition_Set(UINT8 ucSetting)    //A70LV_Doulas_0072 modify
{
    ...
    dvC821_Vert_Start_Position_Set(eMCT_CH2,ucSetting);     //A70LV_Doulas_0155
    eC821Resut = dvC821_Vert_Start_Position_Set(eMCT_CH1,ucSetting);
    if(eC821Resut != eC821_EXEC_CODE_PASS)
    {
        eResult = eHAL_SCALER_EXEC_CODE_FAIL;
    }
...
eHAL_SCALER_EXEC_CODE halScaler_DigitalHorzZoom_Set(UINT16 uiSetting)    //A70LV_Doulas_0072 modify
{
    ...
    dvC821_Digital_Horz_Zoom_Set(eMCT_CH2,uiSetting);    //A70LV_Doulas_0155
    eC821Resut = dvC821_Digital_Horz_Zoom_Set(eMCT_CH1,uiSetting);
    if(eC821Resut != eC821_EXEC_CODE_PASS)
    {
        eResult = eHAL_SCALER_EXEC_CODE_FAIL;
    }
...
eHAL_SCALER_EXEC_CODE halScaler_DigitalVertZoom_Set(UINT16 uiSetting)   //A70LV_Doulas_0072 modify
{
    ...
    dvC821_Digital_Vert_Zoom_Set(eMCT_CH2,uiSetting);    //A70LV_Doulas_0155
    eC821Resut = dvC821_Digital_Vert_Zoom_Set(eMCT_CH1,uiSetting);
    if(eC821Resut != eC821_EXEC_CODE_PASS)
    {
        eResult = eHAL_SCALER_EXEC_CODE_FAIL;
    }
...
eHAL_SCALER_EXEC_CODE halScaler_DigitalHorzShift_Set(UINT8 ucSetting)    //A70LV_Doulas_0072 modify
{
    ...
    dvC821_Digital_Horz_Shift_Set(eMCT_CH2,ucSetting);    //A70LV_Doulas_0155
    eC821Resut = dvC821_Digital_Horz_Shift_Set(eMCT_CH1,ucSetting);
    if(eC821Resut != eC821_EXEC_CODE_PASS)
    {
        eResult = eHAL_SCALER_EXEC_CODE_FAIL;
    }
...
eHAL_SCALER_EXEC_CODE halScaler_DigitalVertShift_Set(UINT8 ucSetting)    //A70LV_Doulas_0072 modify
{
    ...
    dvC821_Digital_Vert_Shift_Set(eMCT_CH2,ucSetting);    //A70LV_Doulas_0155
    eC821Resut = dvC821_Digital_Vert_Shift_Set(eMCT_CH1,ucSetting);
    if(eC821Resut != eC821_EXEC_CODE_PASS)
    {
        eResult = eHAL_SCALER_EXEC_CODE_FAIL;
    }
...
eHAL_SCALER_EXEC_CODE halScaler_AutoImage_Set(UINT8 ucSetting)   //A70LV_Doulas_0112 modify
{
    ...
    dvC821_AutoImage_Set(ucInputSource,ucSetting);
...
eHAL_SCALER_EXEC_CODE halScaler_ColorSpace_Set(UINT8 ucCH,UINT8 ucSetting)   //A70LV_Doulas_0072 modify//A70LV_Doulas_0069 modify
{
    ...
    LOG_MSG(db_HAL_SCALER, "(func:%s, line:%d): ucCH = %d, ColorSpace Set=%d\r\n", __FUNCTION__, __LINE__, ucCH, ucSetting);
    ...
    {
        dvC821_VideoYUV_Set((eMCT)ucCH,ucFrontEndVideoYUV[ucCH]);
        ucSetting = ucFrontEndColorSpace[ucCH];
    }
#endif

    dvC821_ColorSpace_Value_Set((eMCT)ucCH,ucSetting);
...
UINT8 halScaler_ColorSpace_ScalerValueGet(UINT8 ucCH)   //A70LV_Doulas_0220 modify//A70LV_Doulas_0109 modify //A70LV_Doulas_0069
{
    ...
    switch(ucSetting)
    {
        ...
        case eCM_COLOR_SPACE_RGB_FULL:
            dvC821_VideoYUV_Set((eMCT)ucCH,eVIDEO_YUV_UNKNOW);
        ...
        case eCM_COLOR_SPACE_YUV_REC709:
            dvC821_VideoYUV_Set((eMCT)ucCH,eVIDEO_YUV_REC709);
        ...
        case eCM_COLOR_SPACE_YUV_REC601:
            dvC821_VideoYUV_Set((eMCT)ucCH,eVIDEO_YUV_REC601);
            if(ucFrontEndColorSpace[ucCH] == eCOLOR_FORMAT_422)     //A70LV_Doulas_0076 modify
                ucSetting = eCOLOR_FORMAT_422;
            else
                ucSetting = eCOLOR_FORMAT_444;
...
eHAL_SCALER_EXEC_CODE halScaler_Detail_Set(UINT8 ucCH,UINT8 ucSetting)   //A70LV_Doulas_0029 modify
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        dvC821_Set_Sharpness(eMCT_CH1);       //A70LV_Doulas_0155
        dvC821_Set_Sharpness(eMCT_CH2);       //A70LV_Doulas_0155
...
INT8 halScaler_3DEnable_Set(UINT8 ucSetting)        //A70LV_Doulas_0154 modify
{
    ...
    dvC821_OSD_3D_Enable_Set(eMCT_CH1,ucSetting);
    dvC821_OSD_3D_Enable_Set(eMCT_CH2,ucSetting);       //A70LV_Doulas_0155
...
eHAL_SCALER_EXEC_CODE halScaler_SkinColor_Set(UINT8 ucCH,UINT8 ucSetting)    //A70LV_Doulas_0072 modify//A70LV_Doulas_0029
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        dvC821_SkinColor_Set((eMCT)ucCH);
...
eHAL_SCALER_EXEC_CODE halScaler_TemporalNoiseReduction_Set(UINT8 ucSetting)  //A70LV_Doulas_0072 modify//A70LV_Doulas_0029
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        dvC821_BuildPicture_2K(eMCT_CH1);
        if(m_sUserSystemSetting.sSourceSetting.ucPIPEnable)     //A70LV_Doulas_0080
        {
            dvC821_BuildPicture_2K(eMCT_CH2);
        }
        else if((dvC821_PanelGet() == ePANEL_ID_1080P_120HZ) ||
                (dvC821_PanelGet() == ePANEL_ID_WUXGA_120HZ))  //A70LV_Doulas_0377 Modify //A70LV_Doulas_0155
        {
            dvC821_BuildPicture_2K(eMCT_CH2);
        }
...
eHAL_SCALER_EXEC_CODE halScaler_IintChannelSetting(UINT8 ucCH)      //A70LV_Doulas_0155 modify//A70LV_Doulas_0072 modify//A70LV_Doulas_0030 modify //A70LV_Doulas_0029
{
    ...
    if(ucCH == eMCT_CH1)
    {
        ...
        #endif	/*Low_Latency_All*/
        dvC821_IintChannelSetting((eMCT)ucCH,hal_sChannelSetting[eMCT_CH1]);
        ...
        for(ucInputSource = 0 ; ucInputSource < eCM_SOURCE_NUMBER ; ucInputSource++)   //ZU860_Doulas_0011 modify//A70LV_Doulas_0112
            dvC821_AutoImage_Set(ucInputSource,m_sUserSystemSetting.sSourceDependSetting[ucInputSource].ucAutoImage);
    }
    else
    {
        ucMCT_CH = eMCT_CH2;
        ...
        {
            hal_sChannelSetting[eMCT_CH2].iBrightness           = halScaler_Brightness_Value_Get(eMCT_CH2);
        ...
        #endif	/*Low_Latency_All*/
        dvC821_IintChannelSetting((eMCT)ucCH,hal_sChannelSetting[eMCT_CH2]);
...
eHAL_SCALER_EXEC_CODE halScaler_Detail_Value_Set(UINT8 ucCH,UINT8 ucSetting)     //A70LV_Doulas_0072 modify
{
    ...
    dvC821_Sharpness_Value_Set(eMCT_CH1,ucSetting);       //A70LV_Doulas_0155
    dvC821_Sharpness_Value_Set(eMCT_CH2,ucSetting);       //A70LV_Doulas_0155
    return eResult;
}
...
eHAL_SCALER_EXEC_CODE halScaler_SkinColor_Value_Set(UINT8 ucCH,UINT8 ucSetting)  //A70LV_Doulas_0072 modify//A70LV_Doulas_0029 modify
{
    ...
    dvC821_SkinColor_Value_Set(eMCT_CH1,ucSetting);       //A70LV_Doulas_0155
    dvC821_SkinColor_Value_Set(eMCT_CH2,ucSetting);       //A70LV_Doulas_0155
...
eHAL_SCALER_EXEC_CODE halScaler_Temporal_NR_Value_Set(UINT8 ucSetting)   //A70LV_Doulas_0029 modify
{
    ...
    dvC821_Temporal_NR_Value_Set(eMCT_CH1,ucSetting);
    dvC821_Temporal_NR_Value_Set(eMCT_CH2,ucSetting);
...
eHAL_SCALER_EXEC_CODE halScaler_MPEG_NR_Value_Set(UINT8 ucSetting)   //A70LV_Doulas_0029 modify
{
    ...
    dvC821_MPEG_NR_Value_Set(eMCT_CH1,ucSetting);
    dvC821_MPEG_NR_Value_Set(eMCT_CH2,ucSetting);
...
eHAL_SCALER_EXEC_CODE halScaler_DetectFilm_Value_Set(UINT8 ucSetting)        //A70LV_Doulas_0029 modify
{
    ...
    dvC821_Detect_Film_Value_Set(eMCT_CH1,ucSetting);
    dvC821_Detect_Film_Value_Set(eMCT_CH2,ucSetting);
...
eHAL_SCALER_EXEC_CODE halScaler_OSD_TestPattern_Set(UINT8 ucCH,UINT8 ucSetting)      //A70LV_Doulas_0072 modify
{
    ...
    dvC821_TestPattern_Set((eMCT)ucCH,ucSetting);
...
eHAL_SCALER_EXEC_CODE halScaler_InputPixelClock_Get(UINT8 ucCH,UINT8 *ucValue)     //A70LV_Doulas_0056
{
    ...
    dvC821_InputPixelClock_Get((eMCT)ucCH,ucValue);     //A70LV_Doulas_0072 modify
...
eHAL_SCALER_EXEC_CODE halScaler_InputResolution_Get(UINT8 ucCH,UINT8 *ucValue)
{
    ...
    dvC821_InputResolution_Get((eMCT)ucCH,ucValue);     //A70LV_Doulas_0072 modify
...
eHAL_SCALER_EXEC_CODE halScaler_InputHorzRefresh_Get(UINT8 ucCH,UINT8 *ucValue)
{
    ...
    dvC821_InputHorzRefresh_Get((eMCT)ucCH,ucValue);      //A70LV_Doulas_0072 modify
...
eHAL_SCALER_EXEC_CODE halScaler_InputVertRefresh_Get(UINT8 ucCH,UINT8 *ucValue)
{
    ...
    dvC821_InputVertRefresh_Get((eMCT)ucCH,ucValue);      //A70LV_Doulas_0072 modify
...
eHAL_SCALER_EXEC_CODE halScaler_InputVertRefresh2_Get(UINT8 ucCH,UINT16 *uiValue)     //A70LV_Doulas_0200
{
    ...
    dvC821_InputVertRefresh2_Get((eMCT)ucCH,uiValue);
...
eHAL_SCALER_EXEC_CODE halScaler_InputVertRefresh2_Get_FromSyncCount(UINT8 ucCH,UINT16 *uiValue)       //A35G2_CDS_Simon_0052
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        dvC821_InputVertRefresh2_Get_FromMCLKcount((eMCT)ucCH, uiValue);
...
eHAL_SCALER_EXEC_CODE halScaler_InputSignalFormat_Get(UINT8 ucCH,UINT8 *ucValue)
{
    ...
    dvC821_InputSignalFormat_Get((eMCT)ucCH,ucValue);     //A70LV_Doulas_0072 modify
...
eHAL_SCALER_EXEC_CODE halScaler_InputAspectRatio_Get(UINT8 ucCH,UINT8 *ucValue)
{
    ...
    dvC821_InputAspectRatio_Get((eMCT)ucCH,ucValue);        //A70LV_Doulas_0072 modify
...
eHAL_SCALER_EXEC_CODE halScaler_FrontEndColorSpaceInfo_Get(UINT8 ucCH,UINT8* ucValue)     //A70LV_Doulas_0109 Add
{
    ...
    switch(ucFrontEndColorSpace[ucCH])
    {
        ...
        default:
            ...
            {
                ucVal = dvC821_VideoYUV_Get((eMCT)ucCH);
...
eHAL_SCALER_EXEC_CODE halScaler_FrontEndScanMode_Set(UINT8 ucCH,UINT8 ucValue)
{
    ...
    if(ucValue < eSCAN_MODE_NO_SIGNAL)
    {
        ...
        dvC821_FrontEndScanMode_Set((eMCT)ucCH,ucValue);
    }
    else
        eResult = eHAL_SCALER_EXEC_CODE_FAIL;
...
eHAL_SCALER_EXEC_CODE halScaler_FrontEndScanMode_Clear(UINT8 ucCH)      //A70LV_Doulas_0175
{
    ...
    //LOG_MSG(db_ALWAYS, "@@@# %d ,%d \r\n",ucFrontEndeScanMode[ucCH],dvC821_Input_V_Active_Get((eMCT)ucCH));       //A70LV_Doulas_0181
    if((ucFrontEndeScanMode[ucCH] == eSCAN_MODE_INTERLACE) &&
       (dvC821_Input_V_Active_Get((eMCT)ucCH) == 288))    //A70LV_Doulas_0181 modify re-sync 576i V-start error issue,check 576i
    {
        ucFrontEndeScanMode[ucCH] = eSCAN_MODE_NO_SIGNAL;
        dvC821_FrontEndScanMode_Set((eMCT)ucCH,eSCAN_MODE_NO_SIGNAL);
    }
    return eResult;
}
...
{
    return dvC821_ForcedSyncResetType_Get();
}
...
eHAL_SCALER_EXEC_CODE halScaler_ForcedSyncResetDisable_Set(void)
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
...
#ifdef C789_2D_NO_FRAME_LOCK   //A70LV_Doulas_0307 modify
        dvC821_ForceSyncRese_Get(&bForceSyncReseVal2,&uiH_Toral2,&uiV_Toral2);
		#ifdef Low_Latency_All	//G100_Clare_0009
		if(!halScaler_Low_Latency_Get())
        #endif	/*Low_Latency_All*/
		{
            if(halC789Ctrl_TwistLinkFlag_Get())     //A70LV_Doulas_0367 Modify
            {
                ...
                dvC821_ForcedSyncResetDisable_Set2(uiH_Toral2,uiV_Toral2);
            }
            else
            {
                dvC821_ForcedSyncResetDisable_Set();    //disable ForcedSyncReset and reset C821 H-total & V-tatal
            }
            dvC821_ForceSyncRese_Get(&bForceSyncReseVal,&uiH_Toral,&uiV_Toral);     //get C821 H-total & V-total
        ...
        dvC821_ForceSyncRese_Get(&bForceSyncReseVal2,&uiH_Toral,&uiV_Toral);     //A70LV_Doulas_0259//A70LV_Doulas_0168 remove
        //if(bForceSyncReseVal)   //A70LV_Doulas_0168 remove
        {
            dvC821_ForcedSyncResetDisable_Set();    //disable ForcedSyncReset and reset C821 H-total & V-tatal
            dvC821_ForceSyncRese_Get(&bForceSyncReseVal,&uiH_Toral,&uiV_Toral);     //get C821 H-total & V-total
        ...
        if(bForceSyncReseVal2)          //A70LV_Doulas_0259
        {
            ...
            {
                palSysCtrlMgr_XillinxFPGA_Manual_Mode_Set((UINT8)dvC821_PanelGet());
            }
            else
            {
                palSysCtrlMgr_XillinxFPGA_Reset();
...
{
    return dvC821_IsInterlaced_Get((eMCT)ucCH);
}
...
eHAL_SCALER_EXEC_CODE halScaler_Horz_Start_Position_Get(UINT8 ucCH,UINT16* uiVal) //G100_Julie_0017
{
    ...
    *uiVal = dvC821_Horz_Start_Position_Get((eMCT)ucCH);
...
eHAL_SCALER_EXEC_CODE halScaler_Vert_Start_Position_Get(UINT8 ucCH,UINT16* uiVal) //G100_Julie_0017
{
    ...
    *uiVal = dvC821_Vert_Start_Position_Get((eMCT)ucCH);
...
eHAL_SCALER_EXEC_CODE halScaler_VGA_H_Total_Get(UINT8 ucCH,UINT16* uiVal)     //A70LV_Doulas_0112
{
    ...
    *uiVal = dvC821_VGA_H_Total_Get((eMCT)ucCH);
...
eHAL_SCALER_EXEC_CODE halScaler_VGA_V_Total_Get(UINT8 ucCH,UINT16* uiVal)     //A70LV_Doulas_0195
{
    ...
    *uiVal = dvC821_VGA_V_Total_Get((eMCT)ucCH);
...
{
    eHAL_SCALER_EXEC_CODE eResult = eHAL_SCALER_EXEC_CODE_PASS;
    dvC821_VGA_SYNC_TYPE_Set((eMCT)ucCH,ucVal);
...
{
    return dvC821_uiHFreq_Get((eMCT)ucCH);
}
...
eHAL_SCALER_EXEC_CODE halScaler_Position_Run(UINT8 ucCH)    //A70LV_Doulas_0113
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        //dvC821_Position_Run((eMCT)ucCH);      //A70LV_Doulas_0154 remove
        bHorzPositionSettingWork = dvC821_CheckingHorzPositionSettingWork((eMCT)ucCH);
        bVertPositionSettingWork = dvC821_CheckingVertPositionSettingWork((eMCT)ucCH);
...
{
    return dvC821_HorzPositionWorkValueGet((eMCT)ucCH);
}

UINT8 halScaler_VertPositionWorkValueGet(UINT8 ucCH)
{
    return dvC821_VertPositionWorkValueGet((eMCT)ucCH);
}
...
eHAL_SCALER_EXEC_CODE halScaler_AutoPsitionStart(UINT8 ucCH,BOOL bAutoEnable)    //A70LV_Doulas_0118
{
    ...
    dvC821_AutoPsitionStart((eMCT)ucCH,bAutoEnable);
...
eHAL_SCALER_EXEC_CODE halScaler_Config_NoSignalOutput(UINT8 ucCH, UINT8 ucDisplayOutput)      //A70LV_Doulas_0142 //A70LV_Doulas_0120  //A35G2_CDS_Simon_0017
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        dvC821_Config_NoSignalOutput((eMCT)ucCH, ucDisplayOutput);   //A70LV_Doulas_0142  //A35G2_CDS_Simon_0017
        LOG_MSG(db_DV_SCALER, "(func:%s, line:%d) dvC821_Config_NoSignalOutput %d\r\n", __FUNCTION__, __LINE__, ucCH);
...
{
    return dvC821_Input_H_Active_Get((eMCT)ucCH);
}

UINT16 halScaler_Input_V_Active_Get(UINT8 ucCH)     //A70LV_Doulas_0124
{
    return dvC821_Input_V_Active_Get((eMCT)ucCH);
}
...
eHAL_SCALER_EXEC_CODE halScaler_DDR_InputDataAreaTotalGet(UINT8 eCH,RECT DataArea,UINT32 *ulTotalRed,UINT32 *ulTotalGreen,UINT32 *ulTotalBlue)         //A70LV_Doulas_0124
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        dvC821_DDR_InputDataAreaTotalGet((eMCT)eCH ,DataArea ,ulTotalRed ,ulTotalGreen ,ulTotalBlue);
...
eHAL_SCALER_EXEC_CODE halScaler_InputADC_Cali_CalibrationEnableSet(UINT8 eCH,UINT8 ucADC_CAl_Enable)
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        dvC821_InputADC_Cali_CalibrationEnableSet((eMCT)eCH ,ucADC_CAl_Enable);
...
{
    return dvC821_Input_3D_Format_Config_Get();
}
...
eHAL_SCALER_EXEC_CODE halScaler_InputHorzPeriod_Get(UINT8 ucCH,UINT32* udVal)     //A70LV_Doulas_0195
{
    ...
    *udVal = dvC821_InputHorzPeriod_Get((eMCT)ucCH);
...
eHAL_SCALER_EXEC_CODE halScaler_VGA_ModeTable_Get(UINT8 ucCH,UINT8* ucVal)     //A70LV_Doulas_0195
{
    ...
    *ucVal = dvC821_VGA_ModeTable_Get((eMCT)ucCH);
...
eHAL_SCALER_EXEC_CODE halScaler_VGA_ModeTableNumber_Get(UINT8 ucCH,UINT16* uiVal)     //A70LV_Doulas_0195
{
    ...
    *uiVal = dvC821_VGA_ModeTableNumber_Get((eMCT)ucCH);
...
eHAL_SCALER_EXEC_CODE halScaler_ModeAdjusmenttHorzStart_Get(UINT16* uiVal)     //A70LV_Doulas_0195
{
    ...
    *uiVal = dvC821_ModeAdjusmenttHorzStart_Get();
...
eHAL_SCALER_EXEC_CODE halScaler_ModeAdjusmenttVertStart_Get(UINT16* uiVal)     //A70LV_Doulas_0195
{
    ...
    *uiVal = dvC821_ModeAdjusmenttVertStart_Get();
...
eHAL_SCALER_EXEC_CODE halScaler_ModeAdjusmenttHorzStart_Set(UINT16 uiVal)     //A70LV_Doulas_0195
{
    ...
    dvC821_ModeAdjusmenttHorzStart_Set(uiVal);
...
eHAL_SCALER_EXEC_CODE halScaler_ModeAdjusmenttVertStart_Set(UINT16 uiVal)     //A70LV_Doulas_0195
{
    ...
    dvC821_ModeAdjusmenttVertStart_Set(uiVal);
...
eHAL_SCALER_EXEC_CODE halScaler_ModeAdjusmenttEnableSetting(void)         //A70LV_Doulas_0195
{
    ...
    dvC821_ModeAdjusmenttEnableSetting();
...
eHAL_SCALER_EXEC_CODE halScaler_ModeAdjusmenttDisableSetting(void)         //A70LV_Doulas_0195
{
    ...
    dvC821_ModeAdjusmenttDisableSetting();
...
eHAL_SCALER_EXEC_CODE halScaler_Init_Mode_Adjustment_EEPROM_Setting(sTIMING_TABLE sTiming_Table)  //A70LV_Doulas_0195
{
    ...
    dvC821_Init_Mode_Adjustment_EEPROM_Setting(sTiming_Table);
...
eHAL_SCALER_EXEC_CODE halScaler_Input3D_Timing_Get(UINT8 ucCH,UINT8* ucVal)     //A70LV_Doulas_0196
{
    ...
    *ucVal = dvC821_Input3D_Timing_Get((eMCT)ucCH);
...
eHAL_SCALER_EXEC_CODE halScaler_ConfigureForPosition(UINT8 ucCH)     //A70LV_Doulas_0238
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        dvC821_BuildPosition_2K((eMCT)ucCH);
...
eHAL_SCALER_EXEC_CODE halScaler_ConfigureForScaler(UINT8 ucCH)     //A70LV_Doulas_0284
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        dvC821_BuildScaler_2K((eMCT)ucCH);
...
eHAL_SCALER_EXEC_CODE halScaler_EdgeMask_Set(UINT8 ucSetting)       //ZU860_Doulas_0004
{
    ...
    dvC821_EdgeMask_Set(eMCT_CH2,ucSetting);
    eC821Resut = dvC821_EdgeMask_Set(eMCT_CH1,ucSetting);
    if(eC821Resut != eC821_EXEC_CODE_PASS)
    {
        eResult = eHAL_SCALER_EXEC_CODE_FAIL;
    }
...
UINT8 halScaler_IS_3D_Enable(void)         //ZU860_Doulas_0054
{
    ...
    if(uc3D_Mode == ets_OFF)                            //ZU860_Doulas_0049
    {
...
UINT8 halScaler_3D_Type(void)
{
	...
	switch(ucValue)
	{
		...
		case eCM_3D_FORMAT_FRAME_SEQUENTIAL:
			uc3D_Enable = eINPUT_3D_TYPE_FRAME_SEQUENTIAL;
			break;
...
BOOL halScaler_IsVsync120or100Hz_Get(UINT8 ucCH)   //ZU860_Doulas_0104
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        bRet = dvC821_IsVsync120or100Hz_Get((eMCT)ucCH);
...
{
    return dvC821_IsAspectRation16_9_Get();
}

BOOL halScaler_IsAspectRation16_10_Get(void)     //ZU860_Doulas_0120
{
    return dvC821_IsAspectRation16_10_Get();
}
...
eHAL_SCALER_EXEC_CODE halScaler_SourceOutputOff(UINT8 ucCH)     //ZU860_Doulas_0124
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        dvC821_SetInputPort_Output_Off((eMCT)ucCH);
...
UINT8 halScaler_OutputVsyncFreqGetForTwistOn(void)     //A70LV_Doulas_0329
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ucRet = dvC821_OutputVsyncFreqGetForTwistOn();
...
#ifdef Low_Latency_All
INT8 halScaler_Low_Latency_Set(UINT8 ucEnable)
{
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        m_sUserSystemSetting.sCommonSetting.ucLowLatency = ucEnable;
        dvC821_Low_Latency_Set(eMCT_CH1,ucEnable);
        dvC821_Low_Latency_Set(eMCT_CH2,ucEnable);
        dvC821_Set_Flip(eMCT_CH1);
        dvC821_Set_Flip(eMCT_CH2);
...
BOOL halScaler_Low_Latency_Get(void)
{
	return (BOOL)m_sUserSystemSetting.sCommonSetting.ucLowLatency;
}
#endif	/*Low_Latency_All*/
...
UINT8 halScaler_OPD_Test(UINT8 ucData)  //G100_Owen_0137
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        dvC821_Write(B1_TESTG, ucData, 0);
        MS_SLEEP(5);
        ucRet = (dvC821_Read(B1_TESTG, 0) & 0xFF);
...
eHAL_SCALER_EXEC_CODE halScaler_CaptureImage(void)
{
    ...
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        ...
        dvC821_InputImage_Idle_Set(0, TRUE);
        dvC821_InputImage_Idle_Set(1, TRUE);
        dvC821_Freeze_Set(0, TRUE);
        dvC821_Freeze_Set(1, TRUE); //G100_Coda_0097

        dvC821_SerialFlash_Erase_Sector((DEF_LOGOREG_ADDR & 0xFFFF0000), 0x10000);      //G100_Owen_0072 : Erase register table first
        dvC821_SerialFlash_Erase_Sector(DEF_LOGOSFL_ADDR, DEF_LOGOSFL_SIZE);            //G100_Owen_0051
        ulOFLDIdx = (dvC821_Read(B35_STATECH1, 0) & 0x03);
        LOG_MSG(db_HAL_SCALER, "(func:%s, line:%d) ulOFLDIdx[%d]\n", __FUNCTION__, __LINE__, ulOFLDIdx);
        ulOFLDAddr = dvC821_Read(ulOFLDReg[ulOFLDIdx], 0);
        OSD_DMA_DDR3_WriteTo_Flash(ulOFLDAddr, DEF_LOGOSFL_ADDR, 0, DEF_LOGODDR_SIZE);  //G100_Owen_0051
        dvC821_RegTbl_to_Flash(DEF_LOGOREG_ADDR, m_ulCapturedReg, sizeof(m_ulCapturedReg)/sizeof(UINT32));  //G100_Owen_0060
        dvC821_Freeze_Set(0, FALSE);
        dvC821_Freeze_Set(1, FALSE); //G100_Coda_0097
        dvC821_InputImage_Idle_Set(0, FALSE);
        dvC821_InputImage_Idle_Set(1, FALSE);
        m_ucLogo_Load = FALSE;
...
eHAL_SCALER_EXEC_CODE halScaler_CaptureImage_Show(BOOL bEnable)    //G100_Owen_0048
{
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        if(bEnable)
        {
            ...
            dvC821_FlashRead(DEF_LOGOREG_ADDR, 2, aucData);
            if((aucData[0] == 0) && (aucData[1] == 0))  //G100_Owen_0072
            {
                ...
                dvC821_DMA_Transfer(DEF_LOGOREG_ADDR, 130, 0, 0xA); //G100_Owen_0060
                dvC821_CapturedIMG_Output_Set(TRUE);
                dvC821_Channel1_Auto_Fill_Screen_Set(FALSE);
            }
            else
            {
                dvC821_CapturedIMG_Output_Set(FALSE);
        ...
        {
            dvC821_CapturedIMG_Output_Set(FALSE);
            dvC821_Auto_Fill_Screen_Init(); //G100_Owen_0059
        }
        halScaler_SemaphoreGive(__FUNCTION__);
    }
    else
...
eHAL_SCALER_EXEC_CODE halScaler_CaptureImage_Del(BOOL bSourceLock)    //G100_Owen_0048
{
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        dvC821_SerialFlash_Erase_Sector((DEF_LOGOREG_ADDR & 0xFFFF0000), 0x10000);  //G100_Owen_0059
        dvC821_CapturedIMG_Reset(DEF_LOGOREG_ADDR, m_ulCapturedReg, sizeof(m_ulCapturedReg)/sizeof(UINT32));    //G100_Owen_0060
...
eHAL_SCALER_EXEC_CODE halScaler_C821_Auto_Fill_Screen_Init(void) //G100_Steven_0051 start
{
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
    	dvC821_Auto_Fill_Screen_Init();
...
eHAL_SCALER_EXEC_CODE halScaler_C821_Auto_Fill_Screen_Setting(BOOL bSetting)
{
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
    	dvC821_Auto_Fill_Screen_Setting(bSetting);
        halScaler_SemaphoreGive(__FUNCTION__);
    }
    else
    {
...
void halScaler_Test(UINT16 *puiTtlCnt, UINT16 *puiErrCnt)   //G100_Owen_0080
{
    if(halScaler_SemaphoreTake(__FUNCTION__) == TRUE)
    {
        dvC821_Cmd_Test(puiTtlCnt, puiErrCnt);
...
void halScaler_PIPPBPPaniel_InfoSet(BYTE cCH, UINT16 uiHActive, UINT16 uiVActive, UINT16 uiHStart, UINT16 uiVStart) //A35G2_CDS_Larry_0008
{
    ...
    dvC821_PIPPBPPanelInfo_Setting(cCH, &sPanelInfo);

}

void halScaler_PIPPBPPaniel_InfoGet(BYTE cCH, sC821_PANEL_INFO *psInfo)
{
    dvC821_PIPPBPPanelInfo_Get(cCH, psInfo);
}
...
eHAL_SCALER_EXEC_CODE halScaler_ClockGen_Init(eCLOCKGEN_SEL eClockgenSel)
{
    ...
    switch(eClockgenSel)
    {
        ...
        case eCLOCKGEN_SEL_C821_HD:             eCDEC949_Sel = eVCXO_SEL_C821_HD;           break;
        case eCLOCKGEN_SEL_C821_WU:             eCDEC949_Sel = eVCXO_SEL_C821_WU;           break;
        case eCLOCKGEN_SEL_C821_720P:           eCDEC949_Sel = eVCXO_SEL_C821_720P;         break;
        case eCLOCKGEN_SEL_C821_720P120:        eCDEC949_Sel = eVCXO_SEL_C821_720P120;      break;
        case eCLOCKGEN_SEL_C821_800x600_120:    eCDEC949_Sel = eVCXO_SEL_C821_800x600_120;  break;
        case eCLOCKGEN_SEL_C821_1080P120:       eCDEC949_Sel = eVCXO_SEL_C821_1080P120;     break;
        case eCLOCKGEN_SEL_C821_WUXGA120:       eCDEC949_Sel = eVCXO_SEL_C821_WUXGA120;     break;
