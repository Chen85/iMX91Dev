...
#define InterLockSwLost				 0x01090100 //HICC2_Doulas_0117
#define ThermalSwLost				 0x010A0100 //HICC2_Doulas_0117
...
#define FanLock16                    0x03040110   //HICC2_Doulas_0117
#define FanLock17                    0x03040111   //HICC2_Doulas_0117
...
#define FanStallError16              0x03040210   //HICC2_Doulas_0117
#define FanStallError17              0x03040211   //HICC2_Doulas_0117
...
#define FMTENVIRAbnormal01           0x03070600  //HICC2_Doulas_0117
#define FMTENVIRAbnormal02           0x03070601  //HICC2_Doulas_0117
#define FMTENVIRAbnormal03           0x03070602  //HICC2_Doulas_0117
#define FMTENVIRAbnormal04 			 0x03070603  //HICC2_Doulas_0117
...
#define DDPFail01                    0x04050201  //HICC2_Doulas_0117
...
typedef enum  //This enum is copy from xls file, do not edit directly
{
    ...
    eVolt12VLost,
    eVolt3p3VLost,
    eInterLockSwLost,   //HICC2_Doulas_0117
    eThermalSwLost,     //HICC2_Doulas_0117
    eLightModuleBroken,
    ...
    eFanLock14,
    eFanLock15,
    eFanLock16,  //HICC2_Doulas_0117
    eFanLock17,  //HICC2_Doulas_0117
    eFanStallError,
    eFanStallError01,
    eFanStallError02,
    eFanStallError03,
    ...
    eFanStallError14,
    eFanStallError15,
    eFanStallError16, //HICC2_Doulas_0117
    eFanStallError17, //HICC2_Doulas_0117
    eFanStallWarn,
    eFanStallWarn01,
    eFanStallWarn02,
    eFanStallWarn03,
    ...
    eTECAbnormal02,
    eTECAbnormal03,
    eFMTENVIRAbnormal01,  //HICC2_Doulas_0117
    eFMTENVIRAbnormal02,  //HICC2_Doulas_0117
    eFMTENVIRAbnormal03,  //HICC2_Doulas_0117
    eFMTENVIRAbnormal04,  //HICC2_Doulas_0117
    eWheelStop,
    eWheelStop01,
    eWheelStop02,
    eWheelStop03,
...
static const sGEC_ERRORTABLE sGEC_ERRORCODE_TABLE[]=
{
    ...
    {SourceDetSDI,                 eSourceDetSDI,                 "12GSDI  Detected",                "", eHEX,   GEC_REMINDER},
    ...
    {InterLockSwLost,              eInterLockSwLost,              "Interlock Switch Open",           "", eHEX,   GEC_ERROR}, //HICC2_Doulas_0117
    {ThermalSwLost,                eThermalSwLost,                "Thermal Switch Open",             "", eHEX,   GEC_ERROR}, //HICC2_Doulas_0117
    ...
    {FanLock16,                    eFanLock16,                    "Fan Lock 16",                     "", eHEX,   GEC_ERROR}, //HICC2_Doulas_0117
    {FanLock17,                    eFanLock17,                    "Fan Lock 17",                     "", eHEX,   GEC_ERROR}, //HICC2_Doulas_0117
    ...
    {FanStallError16,              eFanStallError16,              "Fan Error 16",                    "", eHEX,   GEC_ERROR}, //HICC2_Doulas_0117
    {FanStallError17,              eFanStallError17,              "Fan Error 17",                    "", eHEX,   GEC_ERROR}, //HICC2_Doulas_0117
    ...
    {FMTENVIRAbnormal01,           eFMTENVIRAbnormal01,           "HIGH AMBIENT WARNING",             "",eHEX,   GEC_WARNING}, //HICC2_Doulas_0117
    {FMTENVIRAbnormal02,           eFMTENVIRAbnormal02,           "HIGH ALTITUDE WARNING",            "",eHEX,   GEC_WARNING}, //HICC2_Doulas_0117
    {FMTENVIRAbnormal03,           eFMTENVIRAbnormal03,           "HIGH HUMIDITY WARNING",            "",eHEX,   GEC_WARNING}, //HICC2_Doulas_0117
    {FMTENVIRAbnormal04,           eFMTENVIRAbnormal04,           "HIGH AMBIENT AND ALTITUDE WARNING","",eHEX,   GEC_WARNING}, //HICC2_Doulas_0117
    ...
    {DDPFail01,                    eDDPFail01,                    "DDP LLFAULT FLASH TABLE",         "", eHEX,   GEC_ERROR}, //HICC2_Doulas_0117
    ...
    {UpgradeFail11,                eUpgradeFail11,                "FPGA Upgrade Fail",               "", eHEX,   GEC_ERROR},
    ...
    {AutoSystemShutdown,           eAutoSystemShutdown,           "Auto System Shutdown",            "", eHEX,   GEC_WARNING},
    {SleepShutdown,                eSleepShutdown,                "Sleep Shutdown",                  "", eHEX,   GEC_WARNING},
    ...
    {I2CError26,                   eI2CError26,                   "DDP EEPROM I2C Fail",             "", eHEX,   GEC_REMINDER},
    {I2CError27,                   eI2CError27,                   "DDP EEPROM XPR I2C Fail",         "", eHEX,   GEC_REMINDER},
    {I2CError28,                   eI2CError28,                   "DDP XPR I2C Fail",                "", eHEX,   GEC_REMINDER},
    {I2CError29,                   eI2CError29,                   "DDP XPR MAX10 I2C Fail",          "", eHEX,   GEC_REMINDER},
    {I2CError30,                   eI2CError30,                   "DDP RX24T I2C Fail",              "", eHEX,   GEC_REMINDER},
    {I2CError31,                   eI2CError31,                   "DDP FMT I2C Fail",                "", eHEX,   GEC_REMINDER},
    {I2CError32,                   eI2CError32,                   "",                                "", eHEX,   0},
    {UARTError,                    eUARTError,                    "Uart Configure Fail",             "", eHEX,   0},
    ...
    {FPGALockFail,                 eFPGALockFail,                 "VCXO Unlock",                     "", eHEX,   0},
