...
typedef enum
{
    eSYSTEM_UPGRADE_MODE_SET             = 0,
    eSYSTEM_UPGRADE_SELECT_LPCMCU        = 1,
    eSYSTEM_UPGRADE_SELECT_NA            = 2,
    eSYSTEM_UPGRADE_SELECT_SCALER        = 3,
    eSYSTEM_UPGRADE_SELECT_DDP           = 4,
    eSYSTEM_UPGRADE_SELECT_STARTUP_BASED = 5,
    eSYSTEM_UPGRADE_SELECT_FPGA          = 6,
    eSYSTEM_UPGRADE_SELECT_All           = 7,

	eSYSTEM_UPGRADE_SECOND_LOGO_REPLACE,
	eSYSTEM_UPGRADE_SERVICE_SECOND_LOGO_REPLACE,
	eSYSTEM_UPGRADE_CUSTOMIZE_EDID,

    eSYSTEM_UPGRADE_MENU_OSD             = 51,
    eSYSTEM_UPGRADE_MENU_DDP             = 52,
    eSYSTEM_UPGRADE_MENU_MCU             = 53,
    eSYSTEM_UPGRADE_MENU_FPGA            = 54,
    eSYSTEM_UPGRADE_MENU_ISO             = 55,

    eSYSTEM_UPGRADE_TEST_1               = 91,
    eSYSTEM_UPGRADE_TEST_2               = 92,
...
//===================== Struct Start ===================//
    ...
    typedef struct
    {
        ...
        UINT8                        ucHostReady;
        UINT8                        ucSystemReady; //datapath is ready
...
typedef struct
{
    ePAL_GEO_FUNCTION eFunction;
    uPALGEOAPI_INFO uData;
}sDRAW_WARP_QUEUE_DATA;
...
void palSystem_12VPwrLostSet(BOOL bFlag);
UINT8 palSystem_OPFUCheck(void);
eRESULT palSystem_AC_Voltage_Check(void);
BYTE palSystem_FilterType_Get(void);
BOOL palSystem_IS_LOGO_Capture_Enble(void);
eRESULT palSystem_Model_ID_Get(void); //A35G2_BRC_Casper_0023
UINT8 palSystem_WaitWheelStable(void);
UINT8 palSystem_LensModelGet(void);
void palSystem_LensModelSet(UINT8 ucType);
void palSystem_TaskMonitor(void);
void palSystem_TaskMonitorTimerReset(eTASK_ID eTaskID, char *InfoStr);
...
eRESULT palSystem_WriteCustomizedEDID(eCM_SOURCE_ID eSource);
void palSystem_ApplyAPModeGeoFunc_Event(void);  //A35G2_Simon_0100
void palSystem_Apply_AP_Mode_GeoFunc(void);
