...
typedef enum
{
	...
	eSYSTEM_MSG_FPGA1_VERSION_SZ               = 3,
	eSYSTEM_MSG_FPGA2_VERSION_SZ               = 3,
	eSYSTEM_MSG_FPGA3_VERSION_SZ               = 2,
	...
	eSYSTEM_MSG_HW_VERSION_SZ                  = 1,
	#ifdef CUSTOM_OPTOMA
	eSYSTEM_MSG_CW_DETECT_SZ         		   = 0,
	eSYSTEM_MSG_PROJECTOR_ADDRESS_SZ           = 1,
	#endif
...
typedef enum
{
    eFMT_MSG_MCU_VERSION_SZ          = 8,					//G100_Clare_0033
...
#ifdef PLATFORM_H60_2K    //HICC2_Doulas_0021
    eFMT_MSG_LD_OVER_TEMPERATURE_SZ  = 8,
#else
...
#ifdef PLATFORM_H60_2K    //HICC2_Doulas_0021
    eFMT_MSG_FAN_LOCK_INDICATE_SZ    = 12,
#else
    ...
    eFMT_MSG_SHUTDOWN_SZ             = 4,  //A70LV_Larry_0200
